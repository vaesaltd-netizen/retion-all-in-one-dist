...
:: Tai zip tu GitHub
powershell -Command "Invoke-WebRequest -Uri 'https://github.com/vaesaltd-netizen/retion-all-in-one-dist/archive/refs/heads/main.zip' -OutFile '%ZIP_FILE%'"
...
set "EXTRACTED=%TEMP_DIR%\retion-all-in-one-dist-main"
